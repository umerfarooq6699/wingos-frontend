...
import starImage from '../assets/Images/starflavour.jpeg'
import { useDispatch, useSelector } from 'react-redux'
import Popup from './Popup'
import SidebarCart from './SidebarCart'
import { starflavour } from '../../Slices/addtocartSlice'
...
const StarFlavour = () => {
    ...
    useEffect(() => {
        window.addEventListener("scroll", () => {
            dispatch(starflavour(star.current.getBoundingClientRect().top))
        })
    }, [])
    ...
    return (
        <>
            <div id="star" ref={star} className='mt-5'>
                        ...
                        <div className='mt-5 grid grid-cols-1 md:grid-cols-2 gap-5'>
                            {
                                ...
                                productsArray.map((e, i) => {
                                    return (
                                        <>
                                            {
                                                e.category === "super star flavour" &&
                                                <>

                                                    <div onClick={() => handleView(e)} className='flex rounded-2xl shadow-xl p-3 border border-blue-50 bg-white cursor-pointer'>
