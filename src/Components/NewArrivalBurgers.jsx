...
import chickenImage from '../assets/Images/newburgers.png'
import { useDispatch, useSelector } from 'react-redux'
import Popup from './Popup'
import { newBurgersDispatch } from '../../Slices/addtocartSlice'
import ReactLoading from "react-loading"

const NewArrivalBurgers = () => {
    const newBurgers = useRef()
    ...
    useEffect(() => {
        window.addEventListener("scroll", () => {
            dispatch(newBurgersDispatch(newBurgers.current.getBoundingClientRect().top))
        })
    })

    return (
        <>
            <div id="newburgers" ref={newBurgers} className='mt-[50px]'>
                        ...
                        <div className='mt-5 grid grid-cols-1 md:grid-cols-2 gap-5'>
                            {
                                ...
                                productsArray.map((e, i) => {
                                    return (
                                        <>
                                            {
                                                e.category === "new arrivals burger" &&
                                                <>
...
export default NewArrivalBurgers