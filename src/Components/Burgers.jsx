...
import burgerImage from '../assets/Images/burgers.jpeg'
import { useDispatch, useSelector } from 'react-redux'
import Popup from './Popup'
import { burgersDispatch } from '../../Slices/addtocartSlice'
...
const Burgers = () => {
    ...
    useEffect(() => {
        window.addEventListener("scroll", () => {
            if (burgers.current) {
                dispatch(burgersDispatch(burgers.current.getBoundingClientRect().top))
            }
        })
    })
    ...
    return (
        <>
            <div id="burgers" ref={burgers} className='mt-[50px]'>
