...
import wingsImage from '../assets/Images/houseofwings.png'
import { useDispatch, useSelector } from 'react-redux'
import Popup from './Popup'
import { wingsDispatch } from '../../Slices/addtocartSlice'
...
const Wings = () => {
    ...
    useEffect(() => {
        window.addEventListener("scroll", () => {
            dispatch(wingsDispatch(wings.current.getBoundingClientRect().top))
        })
    })

    return (
        <>
            <div id="wings" ref={wings} className='mt-[50px]'>
                <div className='w-full'>
                    <img src={wingsImage} alt="" />
                </div>
