...
import chickenImage from '../assets/Images/friedchicken.png'
import { useDispatch, useSelector } from 'react-redux'
import Popup from './Popup'
import { friedChicken } from '../../Slices/addtocartSlice'
...
const FriedChicken = () => {
    ...
    useEffect(() => {
        window.addEventListener("scroll", () => {
            dispatch(friedChicken(fried.current.getBoundingClientRect().top))
        })
    })

    return (
        <>
            <div id="fried" ref={fried} className='mt-[50px]'>
