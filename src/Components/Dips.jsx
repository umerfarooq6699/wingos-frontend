...
import chickenImage from '../assets/Images/dips.jpeg'
import { useDispatch, useSelector } from 'react-redux'
import Popup from './Popup'
import { dipsDispatch } from '../../Slices/addtocartSlice'
...
const Dips = () => {
    ...
    useEffect(() => {
        window.addEventListener("scroll", () => {
            dispatch(dipsDispatch(dips.current.getBoundingClientRect().top))
        })
    })

    return (
        <>
            <div id="dips" ref={dips} className='mt-[50px]'>
