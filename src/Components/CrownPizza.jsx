...
import chickenImage from '../assets/Images/crowndeal.jpeg'
import { useDispatch, useSelector } from 'react-redux'
import Popup from './Popup'
import { crownPizza } from '../../Slices/addtocartSlice'
...
const CrownPizza = () => {
    ...
    useEffect(() => {
        window.addEventListener("scroll", () => {
            dispatch(crownPizza(crown.current.getBoundingClientRect().top))
        })
    }, [])
    ...
    return (
        ...
        <>
            <div id="crown" ref={crown} className='mt-[50px]'>
