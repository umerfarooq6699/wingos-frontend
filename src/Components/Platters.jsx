...
import chickenImage from '../assets/Images/platters.png'
import { useDispatch, useSelector } from 'react-redux'
import Popup from './Popup'
import { platterShawarma } from '../../Slices/addtocartSlice'
import ReactLoading from "react-loading"

const Platters = () => {
    const plattersPizza = useRef()
    ...
    useEffect(() => {
        window.addEventListener("scroll", () => {
            dispatch(platterShawarma(plattersPizza.current.getBoundingClientRect().top))
        })
    }, [])
    ...
    return (
        <>
            <div id="platters" ref={plattersPizza} className='mt-[50px]'>
                        ...
                        <div className='mt-5 grid grid-cols-1 md:grid-cols-2 gap-5'>
                            {
                                ...
                                productsArray.map((e, i) => {
                                    return (
                                        <>
                                            {
                                                e.category === "jumbo chef platters" &&
                                                <>
