...
import chickenImage from '../assets/Images/classicflavours.jpeg'
import { useDispatch, useSelector } from 'react-redux'
import Popup from './Popup'
import { classicFlavours } from '../../Slices/addtocartSlice'
...
const ClassicFlavours = () => {
    ...
    useEffect(() => {
        window.addEventListener("scroll", () => {
            dispatch(classicFlavours(classic.current.getBoundingClientRect().top))
        })
    })

    return (
        <>
            <div id="classic" ref={classic} className='mt-[50px]'>
