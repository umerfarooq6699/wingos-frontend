...
import { dashboardNotificationEmpty, dashboardPage, deleteUser, getProducts, getUsers, userPage } from '../../Slices/adminSlice'
...
const Users = () => {
    ...
    console.log(notification,"notification users")
